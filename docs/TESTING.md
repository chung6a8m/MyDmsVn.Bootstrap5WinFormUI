...
BootstrapSelect pure tests cover logical shell stroke/radius/inset and popup search-host allocation at 96/120/144/192 DPI. The Select page remains the OS-level gate for physical rounded validation/focus strokes, outer/inner popup-border separation, nested `BootstrapTextBox.DeviceDpi`, native text editing/IME, and monitor transitions.
