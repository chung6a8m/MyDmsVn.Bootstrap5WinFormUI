...
- Reviewed the additive `BootstrapModal` public/protected reflection surface and synchronized the approved v1 API fingerprint to `083d66dd9c48507697f4d579b0fdb5cffda552481278cc863b9fb01558117fbd`; modal layout/render/owner/backdrop/transition helpers remain non-public, inherited native Form APIs are not redeclared, and `AssemblyVersion` remains `1.0.0.0`.
