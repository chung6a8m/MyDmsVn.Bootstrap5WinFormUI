...
internal sealed class BootstrapSelectDebouncer : IDisposable
{
    private readonly Timer _timer;
    private Action? _pending;
    private bool _disposed;

    internal BootstrapSelectDebouncer()
    {
        _timer = new Timer();
        _timer.Tick += OnTick;
    }
    ...
    {
        if (_disposed) throw new ObjectDisposedException(nameof(BootstrapSelectDebouncer));
